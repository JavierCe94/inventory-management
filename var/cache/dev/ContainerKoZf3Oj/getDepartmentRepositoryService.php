...
// Returns the private 'App\Infrastructure\Repository\DepartmentRepository\DepartmentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Infrastructure/Repository/DepartmentRepository/DepartmentRepository.php';

return $this->privates['App\Infrastructure\Repository\DepartmentRepository\DepartmentRepository'] = new \App\Infrastructure\Repository\DepartmentRepository\DepartmentRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
