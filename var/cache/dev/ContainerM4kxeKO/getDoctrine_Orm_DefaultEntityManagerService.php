...
$a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->load('getAnnotations_CachedReaderService.php')), array(0 => ($this->targetDirs[3].'/src/Domain/Model/Entity'))), 'Inventory\\Management\\Domain\\Model\\Entity');

$b = new \Doctrine\ORM\Configuration();
$b->setEntityNamespaces(array('Inventory\\Management' => 'Inventory\\Management\\Domain\\Model\\Entity'));
