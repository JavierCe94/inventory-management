...
// Returns the private 'App\Infrastructure\Repository\SubDepartmentRepository\SubDepartmentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Infrastructure/Repository/SubDepartmentRepository/SubDepartmentRepository.php';

return $this->privates['App\Infrastructure\Repository\SubDepartmentRepository\SubDepartmentRepository'] = new \App\Infrastructure\Repository\SubDepartmentRepository\SubDepartmentRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
