...
// Returns the private 'App\Infrastructure\Repository\WorkerStatusRepository\WorkerStatusRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Infrastructure/Repository/WorkerStatusRepository/WorkerStatusRepository.php';

return $this->privates['App\Infrastructure\Repository\WorkerStatusRepository\WorkerStatusRepository'] = new \App\Infrastructure\Repository\WorkerStatusRepository\WorkerStatusRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
