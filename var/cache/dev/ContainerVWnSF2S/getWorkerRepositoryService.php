...
// Returns the private 'App\Infrastructure\Repository\WorkerRepository\WorkerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Infrastructure/Repository/WorkerRepository/WorkerRepository.php';

return $this->privates['App\Infrastructure\Repository\WorkerRepository\WorkerRepository'] = new \App\Infrastructure\Repository\WorkerRepository\WorkerRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
