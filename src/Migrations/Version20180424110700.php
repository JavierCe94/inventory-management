 ...
 */
class Version20180424110700 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sub_department AS SELECT id FROM sub_department');
        ...
        $this->addSql('INSERT INTO sub_department (id) SELECT id FROM __temp__sub_department');
        $this->addSql('DROP TABLE __temp__sub_department');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E1D67247AE80F5DF ON sub_department (department_id)');
        $this->addSql('DROP INDEX UNIQ_FAA2D475AE80F5DF');
        $this->addSql('CREATE TEMPORARY TABLE __temp__worker_status AS SELECT id, department_id, first_contract_date, seniority_date, expiration_contract_date, possible_renewal, available_hollydays, hollydays_pending_to_apply_for FROM worker_status');
        ...
        $this->addSql('INSERT INTO worker_status (id, department_id, first_contract_date, seniority_date, expiration_contract_date, possible_renewal, available_hollydays, hollydays_pending_to_apply_for) SELECT id, department_id, first_contract_date, seniority_date, expiration_contract_date, possible_renewal, available_hollydays, hollydays_pending_to_apply_for FROM __temp__worker_status');
        $this->addSql('DROP TABLE __temp__worker_status');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FAA2D475AE80F5DF ON worker_status (department_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FAA2D475612D3201 ON worker_status (sub_department_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE __temp__department');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CD1DE18AE9F7ADAE ON department (worker_status_id)');
        $this->addSql('DROP INDEX UNIQ_E1D67247AE80F5DF');
        $this->addSql('CREATE TEMPORARY TABLE __temp__sub_department AS SELECT id FROM sub_department');
        $this->addSql('DROP TABLE sub_department');
        $this->addSql('CREATE TABLE sub_department (id INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO sub_department (id) SELECT id FROM __temp__sub_department');
        $this->addSql('DROP TABLE __temp__sub_department');
        $this->addSql('DROP INDEX UNIQ_9FB2BF62ADE62BBB');
        $this->addSql('DROP INDEX UNIQ_9FB2BF6282D4FFC8');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9FB2BF62E9F7ADAE ON worker (worker_status_id)');
        $this->addSql('DROP INDEX UNIQ_FAA2D475AE80F5DF');
        $this->addSql('DROP INDEX UNIQ_FAA2D475612D3201');
        $this->addSql('CREATE TEMPORARY TABLE __temp__worker_status AS SELECT id, department_id, first_contract_date, seniority_date, expiration_contract_date, possible_renewal, available_hollydays, hollydays_pending_to_apply_for FROM worker_status');
        $this->addSql('DROP TABLE worker_status');
        $this->addSql('CREATE TABLE worker_status (id INTEGER NOT NULL, department_id INTEGER DEFAULT NULL, first_contract_date DATETIME DEFAULT \'00/00/00\' NOT NULL, seniority_date DATETIME DEFAULT \'00/00/00\' NOT NULL, expiration_contract_date DATETIME DEFAULT \'00/00/00\' NOT NULL, possible_renewal DATETIME DEFAULT \'00/00/00\' NOT NULL, available_hollydays INTEGER DEFAULT 0 NOT NULL, hollydays_pending_to_apply_for INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO worker_status (id, department_id, first_contract_date, seniority_date, expiration_contract_date, possible_renewal, available_hollydays, hollydays_pending_to_apply_for) SELECT id, department_id, first_contract_date, seniority_date, expiration_contract_date, possible_renewal, available_hollydays, hollydays_pending_to_apply_for FROM __temp__worker_status');
        $this->addSql('DROP TABLE __temp__worker_status');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FAA2D475AE80F5DF ON worker_status (department_id)');
    }
