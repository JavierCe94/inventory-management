 ...
 */
class Version20180424112808 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_E1D6724798C42276');
        $this->addSql('DROP INDEX IDX_E1D67247AE80F5DF');
        $this->addSql('CREATE TEMPORARY TABLE __temp__sub_department AS SELECT id, department_id, department_campo_id FROM sub_department');
        $this->addSql('DROP TABLE sub_department');
        $this->addSql('CREATE TABLE sub_department (id INTEGER NOT NULL, department_id INTEGER DEFAULT NULL, department_campo_id INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_E1D67247AE80F5DF FOREIGN KEY (department_id) REFERENCES department (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E1D6724798C42276 FOREIGN KEY (department_campo_id) REFERENCES department (campo) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO sub_department (id, department_id, department_campo_id) SELECT id, department_id, department_campo_id FROM __temp__sub_department');
        $this->addSql('DROP TABLE __temp__sub_department');
        $this->addSql('CREATE INDEX IDX_E1D6724798C42276 ON sub_department (department_campo_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__department AS SELECT id, worker_status_id, campo FROM department');
        $this->addSql('DROP TABLE department');
        $this->addSql('CREATE TABLE department (id INTEGER NOT NULL, worker_status_id INTEGER DEFAULT NULL, campo INTEGER NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_CD1DE18AE9F7ADAE FOREIGN KEY (worker_status_id) REFERENCES worker_status (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO department (id, worker_status_id, campo) SELECT id, worker_status_id, campo FROM __temp__department');
        ...
        $this->addSql('CREATE TABLE worker (id INTEGER NOT NULL, worker_status_id INTEGER DEFAULT NULL, nif VARCHAR(9) DEFAULT \'-\' NOT NULL COLLATE BINARY, image VARCHAR(100) DEFAULT NULL COLLATE BINARY, name VARCHAR(50) DEFAULT \'-\' NOT NULL COLLATE BINARY, inssnumber VARCHAR(30) DEFAULT \'-\' NOT NULL COLLATE BINARY, tel VARCHAR(12) DEFAULT \'-\' NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_9FB2BF62E9F7ADAE FOREIGN KEY (worker_status_id) REFERENCES worker_status (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__department AS SELECT id, worker_status_id, campo FROM department');
        $this->addSql('DROP TABLE department');
        $this->addSql('CREATE TABLE department (id INTEGER NOT NULL, worker_status_id INTEGER DEFAULT NULL, campo INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO department (id, worker_status_id, campo) SELECT id, worker_status_id, campo FROM __temp__department');
        $this->addSql('DROP TABLE __temp__department');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CD1DE18AE9F7ADAE ON department (worker_status_id)');
        $this->addSql('DROP INDEX IDX_E1D67247AE80F5DF');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sub_department AS SELECT id, department_id, department_campo_id FROM sub_department');
        $this->addSql('DROP TABLE sub_department');
        $this->addSql('CREATE TABLE sub_department (id INTEGER NOT NULL, department_id INTEGER DEFAULT NULL, department_campo_id INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO sub_department (id, department_id, department_campo_id) SELECT id, department_id, department_campo_id FROM __temp__sub_department');
        $this->addSql('DROP TABLE __temp__sub_department');
        $this->addSql('CREATE INDEX IDX_E1D67247AE80F5DF ON sub_department (department_id)');
        $this->addSql('CREATE INDEX IDX_E1D6724798C42276 ON sub_department (department_campo_id)');
        ...
        $this->addSql('DROP TABLE worker');
        $this->addSql('CREATE TABLE worker (id INTEGER NOT NULL, worker_status_id INTEGER DEFAULT NULL, image VARCHAR(100) DEFAULT NULL, nif VARCHAR(9) DEFAULT \'-\' NOT NULL, name VARCHAR(50) DEFAULT \'-\' NOT NULL, inssnumber VARCHAR(30) DEFAULT \'-\' NOT NULL, tel VARCHAR(12) DEFAULT \'-\' NOT NULL, PRIMARY KEY(id))');
