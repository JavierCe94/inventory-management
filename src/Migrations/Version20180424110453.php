 ...
 */
class Version20180424110453 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__department AS SELECT id FROM department');
        ...
        $this->addSql('INSERT INTO department (id) SELECT id FROM __temp__department');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__worker_status AS SELECT id, first_contract_date, seniority_date, expiration_contract_date, possible_renewal, available_hollydays, hollydays_pending_to_apply_for FROM worker_status');
        ...
        $this->addSql('INSERT INTO worker_status (id, first_contract_date, seniority_date, expiration_contract_date, possible_renewal, available_hollydays, hollydays_pending_to_apply_for) SELECT id, first_contract_date, seniority_date, expiration_contract_date, possible_renewal, available_hollydays, hollydays_pending_to_apply_for FROM __temp__worker_status');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__department AS SELECT id FROM department');
        $this->addSql('DROP TABLE department');
        $this->addSql('CREATE TABLE department (id INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO department (id) SELECT id FROM __temp__department');
        $this->addSql('DROP TABLE __temp__department');
        $this->addSql('DROP INDEX UNIQ_9FB2BF62ADE62BBB');
        $this->addSql('DROP INDEX UNIQ_9FB2BF6282D4FFC8');
