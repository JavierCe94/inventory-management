 ...
 */
class Version20180424102905 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE worker_status ADD COLUMN first_contract_date DATETIME DEFAULT \'00/00/00\' NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE __temp__worker');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9FB2BF62E9F7ADAE ON worker (worker_status_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__worker_status AS SELECT id FROM worker_status');
        $this->addSql('DROP TABLE worker_status');
        $this->addSql('CREATE TABLE worker_status (id INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO worker_status (id) SELECT id FROM __temp__worker_status');
