 ...
 */
class Version20180425092006 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE request_employee (id INTEGER NOT NULL, employee INTEGER NOT NULL, date_creation DATETIME NOT NULL, date_modification DATETIME DEFAULT NULL, status VARCHAR(50) DEFAULT \'DRAFT\' NOT NULL, PRIMARY KEY(id))');
    }
