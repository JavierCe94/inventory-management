 ...
 */
class Version20180425062607 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__employee AS SELECT id, employee_status_id, image, nif, name, in_ss_number, telephone FROM employee');
        $this->addSql('DROP TABLE employee');
        $this->addSql('CREATE TABLE employee (id INTEGER NOT NULL, employee_status_id INTEGER DEFAULT NULL, image VARCHAR(100) DEFAULT NULL COLLATE BINARY, nif VARCHAR(9) DEFAULT \'-\' NOT NULL COLLATE BINARY, name VARCHAR(50) DEFAULT \'-\' NOT NULL COLLATE BINARY, in_ss_number VARCHAR(30) DEFAULT \'-\' NOT NULL COLLATE BINARY, telephone VARCHAR(12) DEFAULT \'-\' NOT NULL COLLATE BINARY, type_admin BOOLEAN DEFAULT \'0\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_5D9F75A16E6768FF FOREIGN KEY (employee_status_id) REFERENCES employee_status (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO employee (id, employee_status_id, image, nif, name, in_ss_number, telephone) SELECT id, employee_status_id, image, nif, name, in_ss_number, telephone FROM __temp__employee');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__employee_status AS SELECT id, department_id, sub_department_id, first_contract_date, seniority_date, expiration_contract_date, possible_renewal, available_holly_days, holly_days_pending_to_apply_for FROM employee_status');
        $this->addSql('DROP TABLE employee_status');
        $this->addSql('CREATE TABLE employee_status (id INTEGER NOT NULL, department_id INTEGER DEFAULT NULL, sub_department_id INTEGER DEFAULT NULL, first_contract_date DATETIME DEFAULT \'00/00/00\' NOT NULL, seniority_date DATETIME DEFAULT \'00/00/00\' NOT NULL, expiration_contract_date DATETIME DEFAULT \'00/00/00\' NOT NULL, possible_renewal DATETIME DEFAULT \'00/00/00\' NOT NULL, available_holly_days INTEGER DEFAULT 0 NOT NULL, holly_days_pending_to_apply_for INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_5231A189AE80F5DF FOREIGN KEY (department_id) REFERENCES department (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5231A189612D3201 FOREIGN KEY (sub_department_id) REFERENCES sub_department (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO employee_status (id, department_id, sub_department_id, first_contract_date, seniority_date, expiration_contract_date, possible_renewal, available_holly_days, holly_days_pending_to_apply_for) SELECT id, department_id, sub_department_id, first_contract_date, seniority_date, expiration_contract_date, possible_renewal, available_holly_days, holly_days_pending_to_apply_for FROM __temp__employee_status');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8244BE22A7FF5209 ON film (request_employee_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE INDEX IDX_5231A189AE80F5DF ON employee_status (department_id)');
        $this->addSql('CREATE INDEX IDX_5231A189612D3201 ON employee_status (sub_department_id)');
        $this->addSql('DROP INDEX UNIQ_8244BE22A7FF5209');
        $this->addSql('CREATE TEMPORARY TABLE __temp__film AS SELECT id, request_employee_id, url, date_creation FROM film');
        $this->addSql('DROP TABLE film');
        $this->addSql('CREATE TABLE film (id INTEGER NOT NULL, url VARCHAR(75) DEFAULT NULL, date_creation DATETIME NOT NULL, request_employee_id INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO film (id, request_employee_id, url, date_creation) SELECT id, request_employee_id, url, date_creation FROM __temp__film');
        $this->addSql('DROP TABLE __temp__film');
