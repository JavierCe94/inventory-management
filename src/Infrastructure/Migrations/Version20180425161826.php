 ...
 */
class Version20180425161826 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE garment (id INTEGER NOT NULL, garment_type_id INTEGER DEFAULT NULL, name VARCHAR(50) NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_B881175CE4AFAD8F FOREIGN KEY (garment_type_id) REFERENCES garment_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__garment AS SELECT id, garment_type_id, name FROM garment');
        $this->addSql('DROP TABLE garment');
        $this->addSql('CREATE TABLE garment (id INTEGER NOT NULL, name VARCHAR(50) NOT NULL, garment_type_id INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO garment (id, garment_type_id, name) SELECT id, garment_type_id, name FROM __temp__garment');
        $this->addSql('DROP TABLE __temp__garment');
        $this->addSql('CREATE INDEX IDX_B881175CE4AFAD8F ON garment (garment_type_id)');
        $this->addSql('DROP INDEX IDX_56234C9A9CDB257C');
