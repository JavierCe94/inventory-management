 ...
 */
class Version20180425062825 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__employee AS SELECT id, employee_status_id, image, nif, name, in_ss_number, telephone, type_admin FROM employee');
        ...
        $this->addSql('INSERT INTO employee (id, employee_status_id, image, nif, name, in_ss_number, telephone, type_admin) SELECT id, employee_status_id, image, nif, name, in_ss_number, telephone, type_admin FROM __temp__employee');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE film (id INTEGER NOT NULL, request_employee_id INTEGER DEFAULT NULL, url VARCHAR(75) DEFAULT NULL COLLATE BINARY, date_creation DATETIME NOT NULL, PRIMARY KEY(id))');
