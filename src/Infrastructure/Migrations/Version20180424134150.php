 ...
 */
class Version20180424134150 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE worker (id INTEGER NOT NULL, worker_status_id INTEGER DEFAULT NULL, nif VARCHAR(9) DEFAULT \'-\' NOT NULL COLLATE BINARY, image VARCHAR(100) DEFAULT NULL COLLATE BINARY, name VARCHAR(50) DEFAULT \'-\' NOT NULL COLLATE BINARY, inssnumber VARCHAR(30) DEFAULT \'-\' NOT NULL COLLATE BINARY, tel VARCHAR(12) DEFAULT \'-\' NOT NULL COLLATE BINARY, tel2 VARCHAR(12) DEFAULT \'-\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_9FB2BF62E9F7ADAE FOREIGN KEY (worker_status_id) REFERENCES worker_status (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9FB2BF628A9A9437 ON worker (tel2)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX UNIQ_9FB2BF6282D4FFC8');
        $this->addSql('DROP INDEX UNIQ_9FB2BF62F037AB0F');
        $this->addSql('DROP INDEX UNIQ_9FB2BF628A9A9437');
        $this->addSql('DROP INDEX UNIQ_9FB2BF62E9F7ADAE');
